# Sistema de CRM e Vendas - ZapFlow

Este projeto foi desenvolvido acompanhando uma vídeo-aula, e segui o mesmo escopo apresentado. O **Sistema de CRM e Vendas da ZapFlow** é uma aplicação para gerenciar e validar vendas de forma eficiente, utilizando um frontend interativo com Streamlit, validação de dados com Pydantic e integração com um banco de dados PostgreSQL através de Psycopg2.

## Introdução

O Sistema de CRM e Vendas da ZapFlow foi construído para facilitar a gestão de vendas. A aplicação permite que os usuários insiram dados de vendas diretamente na interface e os validem antes de serem armazenados no banco de dados.
...
Este README serve como guia para configurar, entender, e executar o Sistema de CRM e Vendas da ZapFlow. O projeto combina uma série de tecnologias modernas para proporcionar uma solução eficiente e fácil de usar para gestão de vendas. Com módulos bem definidos e documentação clara ( https://RomuloRangel.github.io/streamlit/), o sistema está preparado para evoluir e se adaptar às necessidades dos usuários.